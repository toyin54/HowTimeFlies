...
let loveReasons: [LoveReason] = [
    ...
    LoveReason(text: "I need the sloppiest everyday this weekend.", isSecret: true),// secret
    LoveReason(text: "I think it’s beautiful the way you sparkle when you talk aboutthe things you love.", isSecret: false),
    LoveReason(text: "Depression is being colorblind and constantly told how colorful the world is. You will see!", isSecret: true)
]
